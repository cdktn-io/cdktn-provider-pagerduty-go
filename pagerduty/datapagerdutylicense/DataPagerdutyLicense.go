...
import (
	...
	"github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v15/datapagerdutylicense/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/data-sources/license pagerduty_license}.
...
func (j *jsiiProxy_DataPagerdutyLicense) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataPagerdutyLicense) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataPagerdutyLicense) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataPagerdutyLicense) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataPagerdutyLicense) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/data-sources/license pagerduty_license} Data Source.
func NewDataPagerdutyLicense(scope constructs.Construct, id *string, config *DataPagerdutyLicenseConfig) DataPagerdutyLicense {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.dataPagerdutyLicense.DataPagerdutyLicense",
...
func (j *jsiiProxy_DataPagerdutyLicense)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataPagerdutyLicense)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataPagerdutyLicense)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataPagerdutyLicense_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataPagerdutyLicense) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataPagerdutyLicense) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataPagerdutyLicense) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataPagerdutyLicense) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataPagerdutyLicense) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
