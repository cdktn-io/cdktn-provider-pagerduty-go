// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for pagerduty.
...
// You can continue to use the pagerduty provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14
