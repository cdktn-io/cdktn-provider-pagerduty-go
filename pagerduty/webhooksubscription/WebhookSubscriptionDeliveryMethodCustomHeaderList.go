...
func (j *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebhookSubscriptionDeliveryMethodCustomHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebhookSubscriptionDeliveryMethodCustomHeaderList {
	_init_.Initialize()
...
func NewWebhookSubscriptionDeliveryMethodCustomHeaderList_Override(w WebhookSubscriptionDeliveryMethodCustomHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebhookSubscriptionDeliveryMethodCustomHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
