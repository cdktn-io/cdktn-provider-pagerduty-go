...
type ServiceDependencyDependencySupportingService struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/service_dependency#id ServiceDependency#id}.
	//
