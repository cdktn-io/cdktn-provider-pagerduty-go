...
func (j *jsiiProxy_ServiceDependencyDependencySupportingServiceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDependencyDependencySupportingServiceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceDependencyDependencySupportingServiceList {
	_init_.Initialize()
...
func NewServiceDependencyDependencySupportingServiceList_Override(s ServiceDependencyDependencySupportingServiceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDependencyDependencySupportingServiceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDependencyDependencySupportingServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceDependencyDependencySupportingServiceList) Resolve(context cdktn.IResolveContext) interface{} {
