...
func (j *jsiiProxy_ServiceDependencyDependencyDependentServiceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceDependencyDependencyDependentServiceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceDependencyDependencyDependentServiceList {
	_init_.Initialize()
...
func NewServiceDependencyDependencyDependentServiceList_Override(s ServiceDependencyDependencyDependentServiceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceDependencyDependencyDependentServiceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceDependencyDependencyDependentServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceDependencyDependencyDependentServiceList) Resolve(context cdktn.IResolveContext) interface{} {
