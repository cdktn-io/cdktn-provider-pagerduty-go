...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationsEventOrchestrationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyEventOrchestrationsEventOrchestrationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyEventOrchestrationsEventOrchestrationsList {
	_init_.Initialize()
...
func NewDataPagerdutyEventOrchestrationsEventOrchestrationsList_Override(d DataPagerdutyEventOrchestrationsEventOrchestrationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationsEventOrchestrationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationsEventOrchestrationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationsEventOrchestrationsList) Resolve(context cdktn.IResolveContext) interface{} {
