...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyEventOrchestrationIntegrationParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyEventOrchestrationIntegrationParametersList {
	_init_.Initialize()
...
func NewDataPagerdutyEventOrchestrationIntegrationParametersList_Override(d DataPagerdutyEventOrchestrationIntegrationParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationParametersList) Resolve(context cdktn.IResolveContext) interface{} {
