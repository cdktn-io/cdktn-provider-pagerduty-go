...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fieldOptionsInput", GoGetter: "FieldOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFieldOptions", GoMethod: "ResetFieldOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetFieldType", GoMethod: "ResetFieldType"},
