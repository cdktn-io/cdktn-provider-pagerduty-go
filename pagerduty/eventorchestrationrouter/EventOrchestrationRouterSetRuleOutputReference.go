...
func (j *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventOrchestrationRouterSetRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventOrchestrationRouterSetRuleOutputReference {
	_init_.Initialize()

	if err := validateNewEventOrchestrationRouterSetRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewEventOrchestrationRouterSetRuleOutputReference_Override(e EventOrchestrationRouterSetRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventOrchestrationRouterSetRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
