...
// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/event_orchestration_router pagerduty_event_orchestration_router}.
type EventOrchestrationRouter interface {
	...
	PutSet(value *EventOrchestrationRouterSet)
	ResetId()
...
func (j *jsiiProxy_EventOrchestrationRouter) CatchAll() EventOrchestrationRouterCatchAllOutputReference {
	var returns EventOrchestrationRouterCatchAllOutputReference
	_jsii_.Get(
		j,
		"catchAll",
		&returns,
...
func (j *jsiiProxy_EventOrchestrationRouter) CatchAllInput() *EventOrchestrationRouterCatchAll {
...
func (j *jsiiProxy_EventOrchestrationRouter) Connection() interface{} {
...
func (j *jsiiProxy_EventOrchestrationRouter) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_EventOrchestrationRouter) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_EventOrchestrationRouter) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EventOrchestrationRouter) EventOrchestration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"eventOrchestration",
...
func (j *jsiiProxy_EventOrchestrationRouter) EventOrchestrationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EventOrchestrationRouter) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EventOrchestrationRouter) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EventOrchestrationRouter) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EventOrchestrationRouter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EventOrchestrationRouter) Node() constructs.Node {
...
func (j *jsiiProxy_EventOrchestrationRouter) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_EventOrchestrationRouter) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_EventOrchestrationRouter) Set() EventOrchestrationRouterSetOutputReference {
	var returns EventOrchestrationRouterSetOutputReference
	_jsii_.Get(
		j,
		"set",
		&returns,
...
func (j *jsiiProxy_EventOrchestrationRouter) SetInput() *EventOrchestrationRouterSet {
	var returns *EventOrchestrationRouterSet
	_jsii_.Get(
		j,
		"setInput",
		&returns,
...
func (j *jsiiProxy_EventOrchestrationRouter) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EventOrchestrationRouter) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/event_orchestration_router pagerduty_event_orchestration_router} Resource.
...
func (j *jsiiProxy_EventOrchestrationRouter)SetCount(val interface{}) {
...
func EventOrchestrationRouter_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateEventOrchestrationRouter_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func EventOrchestrationRouter_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateEventOrchestrationRouter_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EventOrchestrationRouter) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EventOrchestrationRouter) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) MoveFromId(id *string) {
...
func (e *jsiiProxy_EventOrchestrationRouter) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EventOrchestrationRouter) MoveToId(id *string) {
...
func (e *jsiiProxy_EventOrchestrationRouter) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EventOrchestrationRouter) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EventOrchestrationRouter) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) ToHclTerraform() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) ToMetadata() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) ToString() *string {
	var returns *string
...
func (e *jsiiProxy_EventOrchestrationRouter) ToTerraform() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventOrchestrationRouter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
