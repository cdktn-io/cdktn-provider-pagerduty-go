...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserContactMethod)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "address", GoGetter: "Address"},
			_jsii_.MemberProperty{JsiiProperty: "addressInput", GoGetter: "AddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "blacklisted", GoGetter: "Blacklisted"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendShortEmail", GoMethod: "ResetSendShortEmail"},
			_jsii_.MemberProperty{JsiiProperty: "sendShortEmail", GoGetter: "SendShortEmail"},
			_jsii_.MemberProperty{JsiiProperty: "sendShortEmailInput", GoGetter: "SendShortEmailInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-pagerduty.userContactMethod.UserContactMethodConfig",
		reflect.TypeOf((*UserContactMethodConfig)(nil)).Elem(),
	)
}
