...
func (j *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceIntegrationEmailParserValueExtractorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceIntegrationEmailParserValueExtractorList {
	_init_.Initialize()
...
func NewServiceIntegrationEmailParserValueExtractorList_Override(s ServiceIntegrationEmailParserValueExtractorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceIntegrationEmailParserValueExtractorList) Resolve(context cdktn.IResolveContext) interface{} {
