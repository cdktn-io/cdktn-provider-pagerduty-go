...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "finalSchedule", GoGetter: "FinalSchedule"},
			...
			_jsii_.MemberProperty{JsiiProperty: "overflow", GoGetter: "Overflow"},
			_jsii_.MemberProperty{JsiiProperty: "overflowInput", GoGetter: "OverflowInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOverflow", GoMethod: "ResetOverflow"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "renderedCoveragePercentage", GoGetter: "RenderedCoveragePercentage"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rotationTurnLengthSeconds", GoGetter: "RotationTurnLengthSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "rotationTurnLengthSecondsInput", GoGetter: "RotationTurnLengthSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "rotationVirtualStart", GoGetter: "RotationVirtualStart"},
			_jsii_.MemberProperty{JsiiProperty: "rotationVirtualStartInput", GoGetter: "RotationVirtualStartInput"},
