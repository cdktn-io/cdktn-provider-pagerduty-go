...
func (j *jsiiProxy_ScheduleLayerList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*ScheduleLayer; received %#v (a %T)", val, val)
		}
	}
