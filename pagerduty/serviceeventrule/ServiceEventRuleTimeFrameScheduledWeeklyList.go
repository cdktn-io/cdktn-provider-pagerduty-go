...
func (j *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceEventRuleTimeFrameScheduledWeeklyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceEventRuleTimeFrameScheduledWeeklyList {
	_init_.Initialize()
...
func NewServiceEventRuleTimeFrameScheduledWeeklyList_Override(s ServiceEventRuleTimeFrameScheduledWeeklyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceEventRuleTimeFrameScheduledWeeklyList) Resolve(context cdktn.IResolveContext) interface{} {
