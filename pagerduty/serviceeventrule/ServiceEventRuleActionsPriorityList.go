...
func (j *jsiiProxy_ServiceEventRuleActionsPriorityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceEventRuleActionsPriorityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceEventRuleActionsPriorityList {
	_init_.Initialize()

	if err := validateNewServiceEventRuleActionsPriorityListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewServiceEventRuleActionsPriorityList_Override(s ServiceEventRuleActionsPriorityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceEventRuleActionsPriorityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceEventRuleActionsPriorityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceEventRuleActionsPriorityList) Resolve(context cdktn.IResolveContext) interface{} {
