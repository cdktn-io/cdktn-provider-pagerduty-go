...
func (j *jsiiProxy_DataPagerdutyLicensesLicensesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyLicensesLicensesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyLicensesLicensesList {
	_init_.Initialize()
...
func NewDataPagerdutyLicensesLicensesList_Override(d DataPagerdutyLicensesLicensesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyLicensesLicensesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyLicensesLicensesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyLicensesLicensesList) Resolve(context cdktn.IResolveContext) interface{} {
