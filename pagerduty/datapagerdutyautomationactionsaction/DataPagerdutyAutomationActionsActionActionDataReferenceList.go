...
func (j *jsiiProxy_DataPagerdutyAutomationActionsActionActionDataReferenceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyAutomationActionsActionActionDataReferenceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyAutomationActionsActionActionDataReferenceList {
	_init_.Initialize()
...
func NewDataPagerdutyAutomationActionsActionActionDataReferenceList_Override(d DataPagerdutyAutomationActionsActionActionDataReferenceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyAutomationActionsActionActionDataReferenceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyAutomationActionsActionActionDataReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyAutomationActionsActionActionDataReferenceList) Resolve(context cdktn.IResolveContext) interface{} {
