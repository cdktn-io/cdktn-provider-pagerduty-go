...
import (
	...
	"github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v15/user/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.2/docs/resources/user pagerduty_user}.
type User interface {
	...
	SetId(val *string)
	IdInput() *string
	InvitationSent() cdktn.IResolvable
	JobTitle() *string
...
func (j *jsiiProxy_User) AvatarUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"avatarUrl",
...
func (j *jsiiProxy_User) Color() *string {
	var returns *string
	_jsii_.Get(
		j,
		"color",
...
func (j *jsiiProxy_User) ColorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"colorInput",
...
func (j *jsiiProxy_User) HtmlUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"htmlUrl",
...
func (j *jsiiProxy_User) InvitationSent() cdktn.IResolvable {
...
func (j *jsiiProxy_User) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_User) Teams() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"teams",
...
func (j *jsiiProxy_User) TeamsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"teamsInput",
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.2/docs/resources/user pagerduty_user} Resource.
func NewUser(scope constructs.Construct, id *string, config *UserConfig) User {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.user.User",
...
func (j *jsiiProxy_User)SetColor(val *string) {
...
func (j *jsiiProxy_User)SetTeams(val *[]*string) {
...
func (u *jsiiProxy_User) ResetColor() {
	_jsii_.InvokeVoid(
		u,
		"resetColor",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetRole() {
	_jsii_.InvokeVoid(
		u,
		"resetRole",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetTeams() {
	_jsii_.InvokeVoid(
		u,
		"resetTeams",
		nil, // no parameters
