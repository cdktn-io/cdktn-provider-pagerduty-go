...
// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.1/docs/data-sources/event_orchestration_integration pagerduty_event_orchestration_integration}.
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.1/docs/data-sources/event_orchestration_integration pagerduty_event_orchestration_integration} Data Source.
func NewDataPagerdutyEventOrchestrationIntegrationA(scope constructs.Construct, id *string, config *DataPagerdutyEventOrchestrationIntegrationAConfig) DataPagerdutyEventOrchestrationIntegrationA {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.dataPagerdutyEventOrchestrationIntegration.DataPagerdutyEventOrchestrationIntegrationA",
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataPagerdutyEventOrchestrationIntegrationA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationIntegrationA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
