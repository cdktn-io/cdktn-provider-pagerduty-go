...
// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/resources/event_orchestration_global_cache_variable pagerduty_event_orchestration_global_cache_variable}.
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/resources/event_orchestration_global_cache_variable pagerduty_event_orchestration_global_cache_variable} Resource.
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EventOrchestrationGlobalCacheVariable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EventOrchestrationGlobalCacheVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EventOrchestrationGlobalCacheVariable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventOrchestrationGlobalCacheVariable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EventOrchestrationGlobalCacheVariable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventOrchestrationGlobalCacheVariable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
