...
func (j *jsiiProxy_DataPagerdutyUsersUsersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyUsersUsersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyUsersUsersList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.dataPagerdutyUsers.DataPagerdutyUsersUsersList",
...
func NewDataPagerdutyUsersUsersList_Override(d DataPagerdutyUsersUsersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyUsersUsersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyUsersUsersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyUsersUsersList) Resolve(context cdktn.IResolveContext) interface{} {
