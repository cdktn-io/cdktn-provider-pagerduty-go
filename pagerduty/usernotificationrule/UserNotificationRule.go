...
// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/resources/user_notification_rule pagerduty_user_notification_rule}.
...
func (j *jsiiProxy_UserNotificationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_UserNotificationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_UserNotificationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserNotificationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_UserNotificationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/resources/user_notification_rule pagerduty_user_notification_rule} Resource.
func NewUserNotificationRule(scope constructs.Construct, id *string, config *UserNotificationRuleConfig) UserNotificationRule {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.userNotificationRule.UserNotificationRule",
...
func (j *jsiiProxy_UserNotificationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_UserNotificationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_UserNotificationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a UserNotificationRule resource upon running "cdktn plan <stack-name>".
func UserNotificationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (u *jsiiProxy_UserNotificationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserNotificationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (u *jsiiProxy_UserNotificationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserNotificationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
