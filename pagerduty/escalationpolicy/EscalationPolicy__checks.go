...
func (e *jsiiProxy_EscalationPolicy) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (e *jsiiProxy_EscalationPolicy) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (e *jsiiProxy_EscalationPolicy) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (e *jsiiProxy_EscalationPolicy) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (e *jsiiProxy_EscalationPolicy) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (e *jsiiProxy_EscalationPolicy) validatePutRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EscalationPolicyRule; received %#v (a %T)", value, value)
		}
	}
...
func validateEscalationPolicy_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_EscalationPolicy) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
