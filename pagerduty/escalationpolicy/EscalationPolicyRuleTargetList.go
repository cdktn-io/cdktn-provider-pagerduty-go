...
func (j *jsiiProxy_EscalationPolicyRuleTargetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEscalationPolicyRuleTargetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EscalationPolicyRuleTargetList {
	_init_.Initialize()

	if err := validateNewEscalationPolicyRuleTargetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewEscalationPolicyRuleTargetList_Override(e EscalationPolicyRuleTargetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EscalationPolicyRuleTargetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EscalationPolicyRuleTargetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EscalationPolicyRuleTargetList) Resolve(context cdktn.IResolveContext) interface{} {
