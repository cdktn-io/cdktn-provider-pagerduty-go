...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) InternalValue() interface{} {
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList)SetWrapsSet(val *bool) {
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) ComputeFqn() *string {
	var returns *string
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) Get(index *float64) JiraCloudAccountMappingRuleConfigJiraPrioritiesOutputReference {
	if err := j.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns JiraCloudAccountMappingRuleConfigJiraPrioritiesOutputReference
...
func (j *jsiiProxy_JiraCloudAccountMappingRuleConfigJiraPrioritiesList) ToString() *string {
	var returns *string
