...
func (j *jsiiProxy_ResponsePlayResponderTeamList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResponsePlayResponderTeamList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResponsePlayResponderTeamList {
	_init_.Initialize()
...
func NewResponsePlayResponderTeamList_Override(r ResponsePlayResponderTeamList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResponsePlayResponderTeamList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResponsePlayResponderTeamList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResponsePlayResponderTeamList) Resolve(context cdktn.IResolveContext) interface{} {
