...
func (j *jsiiProxy_ResponsePlaySubscriberList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ResponsePlaySubscriberList) InternalValue() interface{} {
...
func (j *jsiiProxy_ResponsePlaySubscriberList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ResponsePlaySubscriberList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ResponsePlaySubscriberList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ResponsePlaySubscriberList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ResponsePlaySubscriberList)SetWrapsSet(val *bool) {
...
func (r *jsiiProxy_ResponsePlaySubscriberList) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_ResponsePlaySubscriberList) Get(index *float64) ResponsePlaySubscriberOutputReference {
	if err := r.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ResponsePlaySubscriberOutputReference
...
func (r *jsiiProxy_ResponsePlaySubscriberList) ToString() *string {
	var returns *string
