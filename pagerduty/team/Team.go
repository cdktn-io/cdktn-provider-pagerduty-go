...
import (
	...
	"github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v15/team/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/resources/team pagerduty_team}.
type Team interface {
...
func (j *jsiiProxy_Team) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Team) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Team) HtmlUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"htmlUrl",
...
func (j *jsiiProxy_Team) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Team) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_Team) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_Team) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Team) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/resources/team pagerduty_team} Resource.
func NewTeam(scope constructs.Construct, id *string, config *TeamConfig) Team {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.team.Team",
...
func (j *jsiiProxy_Team)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Team)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Team)SetParent(val *string) {
...
func (j *jsiiProxy_Team)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Team_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_Team) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_Team) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_Team) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_Team) ResetParent() {
	_jsii_.InvokeVoid(
		t,
		"resetParent",
		nil, // no parameters
...
func (t *jsiiProxy_Team) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
