...
func (j *jsiiProxy_IncidentWorkflowStepList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IncidentWorkflowStepList) InternalValue() interface{} {
...
func (j *jsiiProxy_IncidentWorkflowStepList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IncidentWorkflowStepList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_IncidentWorkflowStepList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_IncidentWorkflowStepList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_IncidentWorkflowStepList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_IncidentWorkflowStepList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IncidentWorkflowStepList) Get(index *float64) IncidentWorkflowStepOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns IncidentWorkflowStepOutputReference
...
func (i *jsiiProxy_IncidentWorkflowStepList) ToString() *string {
	var returns *string
