...
func (j *jsiiProxy_EventOrchestrationIntegrationParametersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EventOrchestrationIntegrationParametersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_EventOrchestrationIntegrationParametersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (e *jsiiProxy_EventOrchestrationIntegrationParametersList) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EventOrchestrationIntegrationParametersList) ToString() *string {
	var returns *string
