...
// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/data-sources/user_contact_method pagerduty_user_contact_method}.
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) CountryCode() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"countryCode",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) DeviceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deviceType",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) Label() *string {
	var returns *string
	_jsii_.Get(
		j,
		"label",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) LabelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelInput",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) Node() constructs.Node {
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) UserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_DataPagerdutyUserContactMethod) UserIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/data-sources/user_contact_method pagerduty_user_contact_method} Data Source.
...
// Experimental.
func DataPagerdutyUserContactMethod_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataPagerdutyUserContactMethod_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataPagerdutyUserContactMethod_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataPagerdutyUserContactMethod_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataPagerdutyUserContactMethod_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-pagerduty.dataPagerdutyUserContactMethod.DataPagerdutyUserContactMethod",
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) ToTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataPagerdutyUserContactMethod) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
