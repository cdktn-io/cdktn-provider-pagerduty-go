...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) Get(index *float64) DataPagerdutyStandardsStandardsExclusionsOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataPagerdutyStandardsStandardsExclusionsOutputReference
...
func (d *jsiiProxy_DataPagerdutyStandardsStandardsExclusionsList) ToString() *string {
	var returns *string
