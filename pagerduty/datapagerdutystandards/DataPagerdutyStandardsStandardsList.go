...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyStandardsStandardsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyStandardsStandardsList {
	_init_.Initialize()
...
func NewDataPagerdutyStandardsStandardsList_Override(d DataPagerdutyStandardsStandardsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyStandardsStandardsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyStandardsStandardsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyStandardsStandardsList) Resolve(context cdktn.IResolveContext) interface{} {
