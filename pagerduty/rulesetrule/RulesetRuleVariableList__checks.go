...
func (j *jsiiProxy_RulesetRuleVariableList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*RulesetRuleVariable:
		val := val.(*[]*RulesetRuleVariable)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*RulesetRuleVariable; received %#v (a %T)", val, val)
		}
	}
