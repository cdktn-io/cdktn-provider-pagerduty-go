...
type RulesetRuleConditions struct {
	...
	// subconditions block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/resources/ruleset_rule#subconditions RulesetRule#subconditions}
