...
func (a *jsiiProxy_AutomationActionsAction) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (a *jsiiProxy_AutomationActionsAction) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (a *jsiiProxy_AutomationActionsAction) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (a *jsiiProxy_AutomationActionsAction) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (a *jsiiProxy_AutomationActionsAction) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validateAutomationActionsAction_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_AutomationActionsAction) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_AutomationActionsAction) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
