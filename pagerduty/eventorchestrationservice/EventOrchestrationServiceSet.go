...
type EventOrchestrationServiceSet struct {
	...
	// rule block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/event_orchestration_service#rule EventOrchestrationService#rule}
