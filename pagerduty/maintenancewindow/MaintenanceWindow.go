...
import (
	...
	"github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v15/maintenancewindow/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/maintenance_window pagerduty_maintenance_window}.
...
func (j *jsiiProxy_MaintenanceWindow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MaintenanceWindow) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_MaintenanceWindow) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_MaintenanceWindow) EndTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endTime",
...
func (j *jsiiProxy_MaintenanceWindow) EndTimeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endTimeInput",
...
func (j *jsiiProxy_MaintenanceWindow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MaintenanceWindow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MaintenanceWindow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MaintenanceWindow) Services() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"services",
...
func (j *jsiiProxy_MaintenanceWindow) ServicesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"servicesInput",
...
func (j *jsiiProxy_MaintenanceWindow) StartTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTime",
...
func (j *jsiiProxy_MaintenanceWindow) StartTimeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTimeInput",
...
func (j *jsiiProxy_MaintenanceWindow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.4/docs/resources/maintenance_window pagerduty_maintenance_window} Resource.
func NewMaintenanceWindow(scope constructs.Construct, id *string, config *MaintenanceWindowConfig) MaintenanceWindow {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.maintenanceWindow.MaintenanceWindow",
...
func (j *jsiiProxy_MaintenanceWindow)SetDescription(val *string) {
...
func (j *jsiiProxy_MaintenanceWindow)SetEndTime(val *string) {
...
func (j *jsiiProxy_MaintenanceWindow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MaintenanceWindow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MaintenanceWindow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MaintenanceWindow)SetServices(val *[]*string) {
...
func (j *jsiiProxy_MaintenanceWindow)SetStartTime(val *string) {
...
func MaintenanceWindow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MaintenanceWindow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MaintenanceWindow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MaintenanceWindow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MaintenanceWindow) ResetDescription() {
	_jsii_.InvokeVoid(
		m,
		"resetDescription",
		nil, // no parameters
...
func (m *jsiiProxy_MaintenanceWindow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
