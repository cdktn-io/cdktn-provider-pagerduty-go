...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationServiceCacheVariableConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataPagerdutyEventOrchestrationServiceCacheVariableConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataPagerdutyEventOrchestrationServiceCacheVariableConditionList {
	_init_.Initialize()
...
func NewDataPagerdutyEventOrchestrationServiceCacheVariableConditionList_Override(d DataPagerdutyEventOrchestrationServiceCacheVariableConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataPagerdutyEventOrchestrationServiceCacheVariableConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationServiceCacheVariableConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataPagerdutyEventOrchestrationServiceCacheVariableConditionList) Resolve(context cdktn.IResolveContext) interface{} {
