...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IncidentCustomField)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-pagerduty.incidentCustomField.IncidentCustomFieldConfig",
		reflect.TypeOf((*IncidentCustomFieldConfig)(nil)).Elem(),
	)
}
