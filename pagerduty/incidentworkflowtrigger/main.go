...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IncidentWorkflowTrigger)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "subscribedToAllServices", GoGetter: "SubscribedToAllServices"},
			_jsii_.MemberProperty{JsiiProperty: "subscribedToAllServicesInput", GoGetter: "SubscribedToAllServicesInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-pagerduty.incidentWorkflowTrigger.IncidentWorkflowTriggerConfig",
		reflect.TypeOf((*IncidentWorkflowTriggerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-pagerduty.incidentWorkflowTrigger.IncidentWorkflowTriggerPermissions",
		reflect.TypeOf((*IncidentWorkflowTriggerPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-pagerduty.incidentWorkflowTrigger.IncidentWorkflowTriggerPermissionsOutputReference",
		reflect.TypeOf((*IncidentWorkflowTriggerPermissionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetRestricted", GoMethod: "ResetRestricted"},
			_jsii_.MemberMethod{JsiiMethod: "resetTeamId", GoMethod: "ResetTeamId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "restricted", GoGetter: "Restricted"},
			_jsii_.MemberProperty{JsiiProperty: "restrictedInput", GoGetter: "RestrictedInput"},
		...
		func() interface{} {
			j := jsiiProxy_IncidentWorkflowTriggerPermissionsOutputReference{}
