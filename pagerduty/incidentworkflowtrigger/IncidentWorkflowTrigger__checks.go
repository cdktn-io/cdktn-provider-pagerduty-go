...
func (i *jsiiProxy_IncidentWorkflowTrigger) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (i *jsiiProxy_IncidentWorkflowTrigger) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (i *jsiiProxy_IncidentWorkflowTrigger) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (i *jsiiProxy_IncidentWorkflowTrigger) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (i *jsiiProxy_IncidentWorkflowTrigger) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (j *jsiiProxy_IncidentWorkflowTrigger) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_IncidentWorkflowTrigger) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
