...
import (
	...
	"github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v15/teammembership/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.1/docs/resources/team_membership pagerduty_team_membership}.
...
func (j *jsiiProxy_TeamMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TeamMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TeamMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TeamMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TeamMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TeamMembership) UserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_TeamMembership) UserIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.1/docs/resources/team_membership pagerduty_team_membership} Resource.
func NewTeamMembership(scope constructs.Construct, id *string, config *TeamMembershipConfig) TeamMembership {
	...
	_jsii_.Create(
		"@cdktn/provider-pagerduty.teamMembership.TeamMembership",
...
func (j *jsiiProxy_TeamMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TeamMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TeamMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_TeamMembership)SetUserId(val *string) {
...
func TeamMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateTeamMembership_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func TeamMembership_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTeamMembership_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TeamMembership_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTeamMembership_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TeamMembership) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TeamMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TeamMembership) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TeamMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TeamMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TeamMembership) MoveFromId(id *string) {
...
func (t *jsiiProxy_TeamMembership) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TeamMembership) MoveToId(id *string) {
...
func (t *jsiiProxy_TeamMembership) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TeamMembership) ToHclTerraform() interface{} {
	var returns interface{}
