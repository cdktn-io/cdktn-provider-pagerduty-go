# CDKTN Go bindings for PagerDuty/pagerduty provider version 3.32.1

This repo builds and publishes the [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.32.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.32.1)
