# CDKTN Go bindings for PagerDuty/pagerduty provider version 3.31.3

This repo builds and publishes the [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.31.3/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.31.3)
